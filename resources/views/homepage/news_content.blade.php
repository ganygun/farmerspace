            ...
            <div class="row post-detail-style2">
                <div class="small-12 medium-12 large-12 columns">
                    <h5>
                        ...
                        >
                        <a href="{{ URL::to('/news/') }}" style="font-weight: 600;">
                            มุมข่าว
                        </a>
                        >
                        <a href="{{ URL::to('/search?key=' .  $ProductName ) }}" style="font-weight: 600;">
                            {{ $ProductName }}
                        </a>
                    </h5>
                </div>
        ...
        <div class="row post-detail-style2" style="margin-top: 40px;">
            <div class="small-12 medium-12 large-8 columns">
                <article class="post post-detail post-18785 type-post status-publish format-standard has-post-thumbnail hentry category-byte tag-demography tag-family tag-featured tag-pregnant" data-id="18785" data-url="https://thematter.co/byte/we-arent-ready-to-be-pregnant/18785" id="post-18785" itemscope="" itemtype="http://schema.org/Article" role="article" style="position: relative;">
                    ...
                    <aside class="share-article hide-on-print fixed-me hide-for-small">
                        <a class="boxed-icon facebook social" href="http://www.facebook.com/sharer.php?u={{ URL::to('/news/' . $ID) }}">
                            ...
                            <span>
                                ...
                                <script>
                                    var settings = {
                                      "async": true,
                                      "crossDomain": true,
                                      "url": "http://graph.facebook.com/?id={{ URL::to('/news/' . $ID) }}",
                                      "method": "GET",
                                      "headers": {
                        ...
                        <a class="boxed-icon twitter social " href="https://twitter.com/intent/tweet?text={{ $Title }}&url={{ URL::to('/news/' . $ID) }}">
                        ...
                        <a class="boxed-icon google-plus social" href="http://plus.google.com/share?url={{ URL::to('/news/' . $ID) }}">
                        ...
                        <a class="boxed-icon comment" href="{{ URL::to('/news/' . $ID) }}">
                            <span>
                                0
                            </span>
                        </a>
                                ...
                                <div class="" style="border: 1px dashed #cccccc;border-radius: 0px;margin:3px;">
                                    <div class="" style="border: 1px dashed #cccccc;border-radius: 0px;margin:3px;">
                                        <div class="row" style="padding:15px;">
                                            <div class="small-12 medium-3 center-block profile-img">
                                               <img class="img img-responsive img-circle" src="{{ $PictureProfile }}" style="margin:auto;">
                                                </img>
                                            </div>
                                            <div class="small-12 medium-7 profile-box ">
                                                <div class="small-12 medium-12 profile-detail">
                                                    <h5 class="head-editor">
                                                        {{ $PenName }}
                    ...
                    <aside class="share-article hide-on-print show-for-small">
                        ...
                        <a class="boxed-icon twitter social " href="https://twitter.com/intent/tweet?text={{ $Title }}&url={{ URL::to('/news/' . $ID) }}$via=farmerspace">
                            <i class="fa fa-twitter">
                            </i>
                            <span>
                                0
            ...
            <div class="small-12 medium-12 large-12 columns">
                    ...
                    <div class="facebook">
                        <div class="fb-like fb_iframe_widget" data-action="like" data-href="" data-layout="button_count" data-share="true" data-show-faces="false" data-width="100px" fb-xfbml-state="rendered">
                            <span style="vertical-align: bottom; width: 120px; height: 20px;">
                                <iframe src="https://www.facebook.com/plugins/like.php?href={{ URL::to('/news/' . $ID) }}&width=124&layout=button_count&action=like&size=small&show_faces=false&share=true&height=46&appId=1136778553087066" width="124" height="46" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                            </span>
                        </div>
                    </div>
                    <div class="twitter">
                        <iframe allowtransparency="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" frameborder="0" id="twitter-widget-0" scrolling="no" src="https://platform.twitter.com/widgets/tweet_button.a0ec3119d8db2bc5422f2144c89ad7a9.en.html#dnt=false&id=twitter-widget-0&lang=en&original_referer={{ URL::to('/news/' . $ID) }}&related={{ URL::to('/')}}&size=m&text={{ $Title }}&time=1488444726544&type=share&url={{ URL::to('/news/' . $ID) }}via=farmerspace" style="position: static; visibility: visible; width: 60px; height: 20px;" title="Twitter Tweet Button">
                        </iframe>
                    </div>
                </div>
                <div id="fb-root">
                ...
                <span style="height: 173px;">
                    <div class="fb-comments fb_iframe_widget fb_iframe_widget_fluid" data-colorscheme="light" data-href="{{ URL::to('/news/' . $ID) }}" data-numposts="5" data-width="100%" fb-xfbml-state="rendered">
                    </div>
                </span>
            </div>
            <!-- Rerate News -->
