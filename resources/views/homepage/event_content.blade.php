            ...
            <div class="row post-detail-style2">
                <div class="small-12 medium-12 large-8 large-offset-2 columns">
                    <h5>
                        ...
                        >
                        <a href="{{ URL::to('event/') }}" style="font-weight: 600;">
                            มุมกิจกรรม
                        </a>
                        >
                        <a href="{{ URL::to('/event/' .  $ID ) }}" style="font-weight: 600;">
                            {{ $Title }}
                        </a>
                    </h5>
                </div>
        ...
        <div class="row post-detail-style2" style="margin-top: 40px;">
            <div class="small-12 medium-12 large-8 large-offset-2 columns">
                <article class="post post-detail post-18785 type-post" id="post-18785" itemscope="" itemtype="http://schema.org/Article" role="article" style="position: relative;">
                    ...
                    <aside class="share-article hide-on-print fixed-me hide-for-small">
                        <a class="boxed-icon facebook social" href="http://www.facebook.com/sharer.php?u={{ URL::to('/event/' . $ID) }}">
                            ...
                            <span>
                                ...
                                <script>
                                    var settings = {
                                      "async": true,
                                      "crossDomain": true,
                                      "url": "http://graph.facebook.com/?id={{ URL::to('/event/' . $ID) }}",
                                      "method": "GET",
                                      "headers": {
                        ...
                        <a class="boxed-icon twitter social " href="https://twitter.com/intent/tweet?text={{ $Title }}&url={{ URL::to('/event/' . $ID) }}">
                        ...
                        <a class="boxed-icon google-plus social" href="http://plus.google.com/share?url={{ URL::to('/event/' . $ID) }}">
                        ...
                        <a class="boxed-icon comment" href="{{ URL::to('/event/' . $ID) }}">
                            <span>
                                0
                            </span>
                        </a>
                    ...
                    <aside class="share-article hide-on-print show-for-small">
                        ...
                        <a class="boxed-icon twitter social " href="https://twitter.com/intent/tweet?text={{ $Title }}&url={{ URL::to('/event/' . $ID) }}$via=farmerspace">
                            <i class="fa fa-twitter">
                            </i>
                            <span>
                                0
            ...
            <div class="small-12 medium-12 large-8 large-offset-2 columns">
                    ...
                    <div class="facebook">
                        <div class="fb-like fb_iframe_widget" data-action="like" data-href="" data-layout="button_count" data-share="true" data-show-faces="false" data-width="100px" fb-xfbml-state="rendered">
                            <span style="vertical-align: bottom; width: 120px; height: 20px;">
                                <iframe src="https://www.facebook.com/plugins/like.php?href={{ URL::to('/event/' . $ID) }}&width=124&layout=button_count&action=like&size=small&show_faces=false&share=true&height=46&appId=1136778553087066" width="124" height="46" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                            </span>
                        </div>
                    </div>
                    <div class="twitter">
                        <iframe allowtransparency="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" frameborder="0" id="twitter-widget-0" scrolling="no" src="https://platform.twitter.com/widgets/tweet_button.a0ec3119d8db2bc5422f2144c89ad7a9.en.html#dnt=false&id=twitter-widget-0&lang=en&original_referer={{ URL::to('/event/' . $ID) }}&related={{ URL::to('/')}}&size=m&text={{ $Title }}&time=1488444726544&type=share&url={{ URL::to('/event/' . $ID) }}via=farmerspace" style="position: static; visibility: visible; width: 60px; height: 20px;" title="Twitter Tweet Button">
                        </iframe>
                    </div>
                </div>
                <div id="fb-root">
                ...
                <span style="height: 173px;">
                    <div class="fb-comments fb_iframe_widget fb_iframe_widget_fluid" data-colorscheme="light" data-href="{{ URL::to('/event/' . $ID) }}" data-numposts="5" data-width="100%" fb-xfbml-state="rendered">
                    </div>
                </span>
            </div>
            <!-- Rerate News -->
