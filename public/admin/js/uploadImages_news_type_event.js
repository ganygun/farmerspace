    ...
    $("#fileUpload").on("change", function(event) {
        ...
        if(event.target.files[0].size > 5242880){
            ...
            var uploadTask = storageRef.child('/FarmerspacePicture/imgNews/Type/Event/'+year+'/'+month+'/' + file.name).put(file, metadata);
    ...
    function deleteProductPic() {
        ...
        var pictureRef = storageRef.child('/FarmerspacePicture/imgNews/Type/Event' + tempFile);
        // Delete the file
